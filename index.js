...
function artistByCountry(artists, nationality) {
  return artists.filter(artist => artist.nationality === nationality && artist.nationality.split(",").length === 1)
